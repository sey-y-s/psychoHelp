...
public class SeanceController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Séance non trouvée avec l'ID fourni")
    })
    ...
    public Seance create(@RequestBody SeanceDTO seance) {
    ...
    @GetMapping("/statut")
    @Operation(summary = "Filtrer les séances par statut", description = "Recherche toutes les séances correspondant à un statut précis (ex: RESERVE, ANNULE).")
    ...
    @Operation(summary = "Lister les séances d'un psychologue", description = "Récupère l'agenda et l'historique des séances associées à un psychologue spécifique.")
